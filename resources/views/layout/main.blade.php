...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ url('assets/vendor/animate.css/animasi.css') }}" rel="stylesheet">
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            ...
            @else
            <li><a href="{{ route('HomePageAdmin') }}" class="text-center">Home Admin</a></li>
            <li><a href="{{ route('PeminjamanAlat') }}">Peminjaman Alat</a></li>
